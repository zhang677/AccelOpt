...
$ACCELOPT_BASE_DIR/templates/complete_local/run_first.sh $INIT_EXP_DATE $EXP_BASE_DIR $EXPERIENCE_LIST_PATH $NC_ID $BREADTH $NUM_SAMPLES $EXP_N $PROJECT_NAME $REL_TOL $ORG_NAME
