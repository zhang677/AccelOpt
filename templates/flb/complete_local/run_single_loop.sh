...
for i in $(seq 1 $ITERS); do
    ...
    $ACCELOPT_BASE_DIR/templates/flb/complete_local/run_body.sh $CURRENT_EXP_DATE $EXP_BASE_DIR $EXPERIENCE_LIST_PATH $BREADTH $NUM_SAMPLES $EXP_N $PROJECT_NAME $ORG_NAME
