...
NC_ID=0
python $COLLECT_EXEC --summary_path $SUMMARY_PATH --output_candidates_path $CANDIDATES_PATH --output_profile_path $PROFILE_PATH --save_fields_path $SAVE_FIELDS_PATH --nc_id $NC_ID