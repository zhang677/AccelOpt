...
# https://github.com/aws-neuron/nki-samples/blob/main/src/nki_samples/tutorials/fused_mamba/mamba_nki_kernels.py#L172
@nki.jit
    ...
    for i_channel_tile in nl.affine_range(n_channel_tile):
        ...
        for i_state in nl.affine_range(state_size):
            ...
            for i_seq_len_tile in nl.static_range(n_seq_len_tile):
                ...
                B_i = nl.load(B[i_state:i_state+1, seq_len_start:seq_len_start+seq_len_fsize])
                ...
                C_i = nl.load(C[i_state:i_state+1, seq_len_start:seq_len_start+seq_len_fsize])
